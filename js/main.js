...
const quizStart = new Quiz('.wrapper',{
    questions: [
        ...
        {question: 'Правда ли что государственный символ Канада бобер?',
        answers: [['Да', 1], ['Нет', 0]]
        },
    ...
    results: [['Надо бы подучить тему, а то как жить в этой стране?', 3], ['Неплохо, но есть что подучить', 4], ['Хорошо, можно перезжать', 5], ['Отлично, когда переезжаем?', 6]]
});
